...
{
    public partial class KasirAddPelanggan : Form
    {
        ...
        public KasirAddPelanggan()
        {
            InitializeComponent();
        }

        private void KasirAddPelanggan_Load(object sender, EventArgs e)
        {
            tampilData();
            kodeOtomatis();
        }
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            printer.Title = "Laporan Data Pembeli Caffe Kendedes";
